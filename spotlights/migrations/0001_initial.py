# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-04-12 19:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('title', models.CharField(max_length=200)),
                ('queue', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='spotlights.Queue')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='queue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='spotlights.Queue'),
        ),
    ]
